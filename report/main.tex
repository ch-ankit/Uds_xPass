...
rare types degrades calibration almost everywhere. Per-type isotonic recalibration fails on every rare type while leaving Ordinary untouched. An equal-n downsampling experiment shows Ordinary passes degrade tenfold when starved to rare-type sample sizes, since most of the gap is scarcity and estimator noise, with a residual $\sim$1.5--2$\times$ type-intrinsic penalty surviving matching. We conclude
...
(200 resamples; five largest seasons, $\sim$82k Ordinary pooled).
Two facts emerge. First, scarcity dominates: Ordinary ECE inflates roughly
tenfold going from full pool (0.003) to n~=~539 (0.032, 95\% interval
0.016--0.049) since most of the rare-type gap is sample size plus binning
noise. Second, a residual type effect survives equal n: at matched sizes,
Cross (0.056) and Switch (0.031) calibrate about twice as badly as
Ordinary (0.029 and 0.016), and Through balls (0.045) about 1.4$\times$
worse than Ordinary at n~=~539 (0.032). Scarcity explains the bulk of the
...
\midrule
Ordinary (full) & 81997 & 0.095 & 0.003 & n/a \\
Ordinary@n=10000 & 10000 & n/a & 0.008 & 0.004--0.012 \\
Ordinary@n=2179 & 2179 & n/a & 0.016 & 0.009--0.024 \\
Switch & 2179 & 0.117 & 0.031 & n/a \\
Ordinary@n=666 & 666 & n/a & 0.029 & 0.016--0.045 \\
Cross & 666 & 0.176 & 0.056 & n/a \\
Ordinary@n=539 & 539 & n/a & 0.032 & 0.016--0.049 \\
Through ball & 539 & 0.233 & 0.045 & n/a \\
\bottomrule
\end{tabular}
...
(\url{downsample_summary.csv}). Scarcity explains most of the gap; a $\sim$1.5--2$\times$ residual remains.}
\label{tab:down}
\end{table}
...
Ordinary passes degrade tenfold when starved to rare-type sizes,
though a $\sim$1.5--2$\times$ residual gap survives matching, so rare
